...
def generate_random_filename(length=8, ext=".wav"):
...
tts = TTS(model_name="tts_models/et/cv/vits", progress_bar=False)

# Generate a random file name and use it as the file path
file_name = generate_random_filename()
tts.tts_to_file(
    text="Hello, this is Coqui TTS running your script. If it’s missing or the path is wrong, SoundFile (used by torchaudio) will fail to speaking!",
    file_path=file_name
)
...
#   6: vocoder_models/en/ljspeech/multiband-melgan [already downloaded]
